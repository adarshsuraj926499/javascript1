...
//     name: "rahul",
//     age: 35,
//     hobbies: ['cicket', 'coding']
// }
// console.log(`Hello ${user1.name,user1.age,user1.hobbies}, how are you today?`);
...
// console.log(mycar.make + " " + mycar.model + " is made in");
...
let myObject = createObject("Utkarsh");
myObject.setter();
...
// let y = 2;
// let z = 3;
// console.log(abc(x, y, z));

//-------------------------------------------------------------------------------------------


function multiplyObject(obj, N) {
    obj.id *= N;
    obj.houseno *= N;
}
// Sample input
...
// Call the function
multiplyObject(obj, N);
console.log(`ID : ${obj.id}`, multiplyObject);

// Now obj.id will be 24 and obj.houseno will be 292