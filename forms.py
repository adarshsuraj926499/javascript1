...
class savePost(forms.ModelForm):
    ...
    youtube_link = forms.URLField(max_length=200, required=False, label="YouTube Video Link")  # Add this field



    class Meta():
        model = models.Post
        fields = ('user', 'category', 'title', 'short_description', 'content', 'meta_keywords', 'banner_path', 'status','youtube_link')
